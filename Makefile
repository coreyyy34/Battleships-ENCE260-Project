...
game.out: game.o button.o ir_uart.o pio.o prescale.o system.o timer.o timer0.o usart1.o display.o ledmat.o navswitch.o font.o pacer.o tinygl.o led.o game_state.o board.o message.o ir.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
	$(SIZE) $@
